...
type AppRole = 'admin' | 'inventory_officer' | 'workshop_worker' | 'sales_officer' | 'driver' | 'lowering_gear_operator' | 'branch_manager' | 'accountant';

interface AuthContextType {
  user: User | null;
  session: Session | null;
  role: AppRole | null;
  profile: { id: string; full_name: string; email: string; phone: string | null; branch_id: string | null } | null;
  loading: boolean;
